...
#define HT16K33_CMD_SYSTEM  0x20
#define HT16K33_CMD_KEYS    0x40
#define HT16K33_CMD_INTFLAG 0x60
...
public:
    ...
    void setRowIntPin(bool row_int, bool act);
    ...
    // Keyscan functions
    void getKeyData(uint16_t _key_buffer[]);

    bool getKeyInterrupt(void);
